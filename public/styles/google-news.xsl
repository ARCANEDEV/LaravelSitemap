...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html lang="en">
            <head>
                <meta charset="utf-8"/>
                <title>XML SitemapManager (for Google News)</title>
            ...
            <body>
                <div id="content">
                    <h2>XML SitemapManager (for Google News)</h2>
                    <p class="expl">
                        Generated by <a href="https://roumen.it/projects/laravel-sitemap/" target="_blank" title="SitemapManager generator for Laravel">laravel-sitemap</a>.
                        This is styled version xml sitemap (for Google News), sorted by update date.
                    </p>
                    <p class="expl">
