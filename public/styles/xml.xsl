...
<head>
<meta charset="utf-8"/>
<title>XML SitemapManager</title>
...
.url:hover
{
  ...
  <body>
	<div id="content">
	  	<h2>XML SitemapManager</h2>
		<p class="expl">Generated by <a href="https://roumen.it/projects/laravel-sitemap/" target="_blank" title="SitemapManager generator for Laravel">laravel-sitemap</a>. This is styled xml sitemap, sorted by update date.</p>
