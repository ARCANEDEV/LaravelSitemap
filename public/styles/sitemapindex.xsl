...
<head>
<meta charset="utf-8"/>
<title>XML SitemapManager Index</title>
...
.url:hover
{
  ...
  <body>
	<div id="content">
	  	<h2>XML SitemapManager Index</h2>
		<p class="expl">Generated by <a href="https://roumen.it/projects/laravel-sitemap/" target="_blank" title="SitemapManager generator for Laravel">laravel-sitemap</a>. This is styled xml sitemapindex, sorted by update date.</p>
