...
<head>
<meta charset="utf-8"/>
<title>XML SitemapManager (for Feature Phones)</title>
...
.url:hover
{
  ...
  <body>
	<div id="content">
	  	<h2>XML SitemapManager (for Feature Phones)</h2>
		<p class="expl">Generated by <a href="https://roumen.it/projects/laravel-sitemap/" target="_blank" title="SitemapManager generator for Laravel">laravel-sitemap</a>. This is styled xml sitemap (for feature phones).</p>
